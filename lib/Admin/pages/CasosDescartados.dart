...
class CasosDescartados extends StatefulWidget {
  const CasosDescartados({super.key});

  @override
  State<CasosDescartados> createState() => _CasosDescartadosState();
}

class _CasosDescartadosState extends State<CasosDescartados> {
  ...
  void initState() {
    super.initState();
    reporteController.consultarReportesPorEstado("Descartado");
  }
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.filter_list, color: Colors.deepPurple[800]),
