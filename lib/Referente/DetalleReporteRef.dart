...
class DetalleReporteRef extends StatelessWidget {
  ...
  const DetalleReporteRef(
      {super.key, required this.casoId, required this.data});

  @override
  Widget build(BuildContext context) {
    final List<String>? comentarios =
        data['ComentRef'] != null ? List<String>.from(data['ComentRef']) : null;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildListTile(
                  'Apellidos', data['apellidos'], Icons.person_outline),
              ...
              _buildListTile(
                  'Comuna Evento', data['comuna_evento'], Icons.event),
              _buildListTile(
                  'Descripción', data['descripcion'], Icons.description),
              _buildListTile('Estado', data['estado'], Icons.flag),
              _buildListTile(
                  'Fecha Incidente', data['fecha_incidente'], Icons.date_range),
                  ...
                  onPressed: () async {
                    if (comentarioController.text.isNotEmpty) {
                      await FirebaseFirestore.instance
                          ...
                          .update({
                        'ComentRef':
                            FieldValue.arrayUnion([comentarioController.text]),
